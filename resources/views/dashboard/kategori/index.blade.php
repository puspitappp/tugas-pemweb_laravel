...
<div class="table-responsive small">
    <a href="/dashboard/kategori/create" class="btn btn-success btn-sm mb-3">Tambah Data</a>
        ...
        <thead>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/dashboard/kategori/{{ $kategori->kat_id }}/edit" class="btn btn-warning btn-sm"><i class="bi bi-pencil"></i></a>
